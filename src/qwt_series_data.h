...
//! Interface for iterating over an array of points
class QWT_EXPORT QwtPointCusSeriesData: public QwtArraySeriesData<QwtPointCus>
{
public:
    QwtPointCusSeriesData(
        const QVector<QwtPointCus> & = QVector<QwtPointCus>() );
...
QWT_EXPORT QRectF qwtBoundingRect(
    const QwtSeriesData<QwtPointCus> &, int from = 0, int to = -1 );
